...
public class ExamesController {
	...
	@GetMapping("/1")
  public List<GetExames2DTO> getExames(
	      @RequestParam String nomeExame,
	      @RequestParam String localidade,
	      @RequestParam String uf,
	      @RequestParam String bairro) {
	   return examesServices.getExamesByNomeExameAndLocalidade(nomeExame, localidade, uf, bairro);
}
